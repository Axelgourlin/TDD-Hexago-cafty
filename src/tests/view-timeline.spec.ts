...
describe("Feature: Viewing a personal timeline", () => {
  ...
  describe("Rule: Messages are shown in reverse chronological order", () => {
    test("Alice can view 2 messages she have published in her timeline", async () => {
      fixture.givenTheFollowingMessagesExist([aliceMessage1, aliceMessage2, aliceMessage3, bobMessage1]);
      ...
      fixture.thenUserShouldSee([
        {
          author: aliceMessage3.author,
          text: aliceMessage3.text,
...
export const aliceMessage3: Message = {
  id: "message-id-4",
  author: "Alice",
